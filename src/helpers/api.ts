...
export const getAccaunt = async (id:string):Promise<IResponse> => {
...
export const handleFollow = async (id:number):Promise<IResponse> => {
  ...
  console.log(response.data, 5555555555)
  return response.data;
}
...
export const handlCancelation = async (id:number):Promise<IResponse> => {
  const response = await Axios.delete('/request/cancel/' + id);
  return response.data;
}


export const handleAllFollowRequest = async ():Promise<IResponse> => {
...
export const allFollowFollowers =  async ():Promise<IResponse> => {  
  const response = await Axios.get("/followers");
  return response.data;
}

export const allFollowFollowings =  async ():Promise<IResponse> => {  
